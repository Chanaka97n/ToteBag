...
<ul>
  ...
  <tr>
		...
		if(mysqli_num_rows($result)> 0)
	{
	  ...
	  echo "<td width='172'><a href='updateStuff.php?id=".$row["itemId"]."'><img src='images/edit2.png' alt='' width='32' height='34' />Edit</a></td>  ";
	  echo " <td width='171'><a href='editContent.php'><img src='images/delete.jpg' alt='' width='32' height='34' /></a><a href='deleteContent.php?id=".$row["itemId"]."'>Delete </a></td> ";
	  	  echo " <td width='153'><img src='images/publish2.png' alt='' width='32' height='34' /><a href='publishContent.php?id=".$row["itemId"]."'>Publish</a></td> </tr>";
